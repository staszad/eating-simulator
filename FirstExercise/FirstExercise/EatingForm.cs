...
namespace FirstExercise
{
    public partial class EatingForm : Form
    {
        public EatingForm()
        {
            ...
            gridControl1.DataSource = Form1.instance.userStats.boughtFood;
        }
        ...
        private void eatButtonClick(object sender, EventArgs e)
        {
            ...
            foreach (Food f in boughtFood)
            {
                if (f.name == foodNameEdit.Text)
                {
                    ...
                    Form1.instance.userStats.EnergyLevel += f.energy;
                    Form1.instance.userStats.HungerPercentage =  Form1.instance.userStats.EnergyLevel / Form1.instance.userStats.EnergyNeeded * 100;
